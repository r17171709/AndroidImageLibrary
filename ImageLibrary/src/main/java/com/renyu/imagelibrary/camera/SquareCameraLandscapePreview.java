 ...
 *
 */
public class SquareCameraLandscapePreview extends SurfaceView {
    private static final String TAG = SquareCameraLandscapePreview.class.getSimpleName();
    ...
    public SquareCameraLandscapePreview(Context context) {
        super(context);
        init(context);
    }

    public SquareCameraLandscapePreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SquareCameraLandscapePreview(Context context, AttributeSet attrs, int defStyle) {
